...
from issues_and_comments.permissions import IsIssueAuthorOrContributor, IsCommentAuthorOrReadOnly
...
class IssueViewSet(viewsets.ModelViewSet):
    ...
    def perform_update(self, serializer):
        """
        Gère la mise à jour des issues selon les permissions définies.
        """
        serializer.save()
